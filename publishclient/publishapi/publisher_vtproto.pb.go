...
func (m *GetConfigResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.IndexFileName) > 0 {
		i -= len(m.IndexFileName)
		copy(dAtA[i:], m.IndexFileName)
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.IndexFileName)))
		i--
		dAtA[i] = 0x32
	}
	if len(m.MemberUrlTemplate) > 0 {
		i -= len(m.MemberUrlTemplate)
		copy(dAtA[i:], m.MemberUrlTemplate)
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.MemberUrlTemplate)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.InviteLinkUrlTemplate) > 0 {
		i -= len(m.InviteLinkUrlTemplate)
		copy(dAtA[i:], m.InviteLinkUrlTemplate)
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.InviteLinkUrlTemplate)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.BaseUrlTemplate) > 0 {
		i -= len(m.BaseUrlTemplate)
		copy(dAtA[i:], m.BaseUrlTemplate)
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.BaseUrlTemplate)))
		i--
		dAtA[i] = 0x1a
	}
	if m.DefaultLimit != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.DefaultLimit))
		i--
		dAtA[i] = 0x10
	}
	if m.MembershipLimit != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.MembershipLimit))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *GetConfigResponse) SizeVT() (n int) {
	...
	_ = l
	if m.MembershipLimit != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.MembershipLimit))
	}
	if m.DefaultLimit != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.DefaultLimit))
	}
	l = len(m.BaseUrlTemplate)
	if l > 0 {
		n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
	}
	l = len(m.InviteLinkUrlTemplate)
	if l > 0 {
		n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
	}
	l = len(m.MemberUrlTemplate)
	if l > 0 {
		n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
	}
	l = len(m.IndexFileName)
	if l > 0 {
		n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
	}
	n += len(m.unknownFields)
...
func (m *GetConfigResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MembershipLimit", wireType)
			}
			m.MembershipLimit = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MembershipLimit |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BaseUrlTemplate", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.BaseUrlTemplate = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field InviteLinkUrlTemplate", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.InviteLinkUrlTemplate = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MemberUrlTemplate", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.MemberUrlTemplate = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field IndexFileName", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.IndexFileName = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := protohelpers.Skip(dAtA[iNdEx:])
